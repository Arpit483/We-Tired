...
[*] Starting GPS module...
[✓] GPS module started (PID: 12347)
[*] Starting Firebase bridge...
[✓] Firebase bridge started (PID: 12348)
...
tail -f gps.log      # GPS logs
tail -f firebase.log # Firebase logs
```
...
- See live detections
- Map shows yellow markers for detections with GPS
...
| **Stop All** | `pkill -f 'python.*(app|deep|neo6m|firebase)'` |
...
- [ ] Map displays: Yellow markers appear for detections with GPS
...
3. **Verify GPS** coordinates are being captured
