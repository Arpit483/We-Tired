...
sudo systemctl start vitalradar-gps
sudo systemctl start vitalradar-firebase
...
```bash
sudo systemctl disable vitalradar vitalradar-deep vitalradar-gps vitalradar-firebase
```
