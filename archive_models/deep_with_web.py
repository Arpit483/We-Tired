...
# =====================================================================================
# WEB INTEGRATION - ADDED TO YOUR ORIGINAL CODE
# =====================================================================================
sensor_states = {1: {}, 2: {}}
...
# =====================================================================================
# THREAD WORKER FOR EACH SENSOR (YOUR EXACT ORIGINAL CODE + 1 LINE)
# =====================================================================================
def run_sensor(sensor_id, port, model, device):
    prefix = f"[S{sensor_id}]"
    print(f"{prefix} Opening {port} ...")
    
    try:
        ser = serial.Serial(port, Config.BAUD, timeout=Config.TIMEOUT)
    except Exception as e:
        print(f"{prefix} Failed to open port {port}: {e}")
        return
