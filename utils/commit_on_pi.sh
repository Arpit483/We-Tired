...
# Example: ./commit_on_pi.sh 192.168.1.100 pi "Add GPS integration and map features"
...
COMMIT_MSG="${3:-Update: GPS integration, map visualization, and connection fixes}"
